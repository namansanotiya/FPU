// ============================================================
// Testbench : tb_alu_cla_16bit
// Description : Simulation testbench for 16-bit CLA ALU
// ============================================================
`timescale 1ns / 1ps

module tb_alu_cla_16bit;
    ...
    initial begin
        $display("=== 16-bit CLA ALU Testbench ===");
    ...
    initial begin
        $dumpfile("tb_alu_cla_16bit.vcd");
        $dumpvars(0, tb_alu_cla_16bit);
    end
